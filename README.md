...
$H, H' \leq G$ — **сопряжённые**, если $\exists x \in G: H' = xHx^{-1}$.
...
Обозначение: $G = \langle x \rangle$, где $x$ — **образующая** $G$.
...
**Теорема 5.4.** Число силовских p-подгрупп в конечной группе $G$ равно $1$ при взятии по модулю $p$: $\equiv 1 \mod p$.
