...
**Nota bene** Если $H$ - нормальная подгруппа $G$, то обычно пишут $H$ (треугольник) $G$.
...
**Теорема 2.1.** Пусть $H$ (треугольник) $G$, тогда существует такой гомоморфизм $\phi$ (называемый **каноническим**), что $ker \phi = H$.

Рассмотрим отображение
$$\phi : G \to G/H,\ \ \phi(x) = xH,$$
и прямой проверкой убеждаемся, что
$$\phi \in hom(G, G/H),\ \ ker \phi - H.$$
