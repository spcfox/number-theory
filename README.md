...
$$0 \rightarrow G \xrightarrow{\sigma} G' \xrightarrow{\chi} G'' \rightarrow 0$$
называется **короткой точной последовательностью**, если $ker \chi = Im \sigma$.
...
**Лемма 2.5.** Пусть $G$ и $G'$ - группы и $\sigma \in Hom(G, G")$, так что $ker\sigma = H$, и пусть $\upvarphi: G \to G/H$ - каноническое отображение. Тогда существует единственный гомоморфизм $\sigma_{\*}: G/H \to G'$ инъективный и такой что
$$\sigma = \sigma_{\*}\circ\upvarphi.$$
