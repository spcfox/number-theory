...
$\sigma \in Hom(G, G')$.
  ...
  **Ядро** гомоморфизма: $\text{Ker} \ \sigma = \lbrace x \in G \hspace{3} \vert \hspace{3}  \sigma(x) = e_{G'} \rbrace$
  
  **Образ** гомоморфизма: $\text{Im} \ \sigma  = \lbrace y \in G' \hspace{3}  \vert \hspace{3} \exists x \in G: \sigma(x) = y \rbrace$
...
Группа $G$ -- **циклическая**, если $\exists x \in G: \forall y \in G \hspace{6} \exists m \in \mathbb{Z}: y = x^m$.
...
Тогда $H := \{x^m\}_{m \hspace{1} \in \hspace{1} \mathbb{Z}}$ -- циклическая подгруппа $G$.
...
- Пусть $\sigma$ инъективен, т.е. $\text{Ker} \hspace{3} \sigma = {0}$.<br>
Тогда $\sigma : \text{Iso}(\mathbb{Z}, \text{Im} \hspace{3} \sigma)$, а также $\exists H < G$, где $H$ -- **циклическая** и **бесконечная**.

- Пусть $H := \text{Ker} \hspace{3} \sigma = \{k \cdot d\}_{k \hspace{1}\in \hspace{1}\mathbb{Z}} \leq \mathbb{Z}$; $d := \min H, d > 0, d$ -- период $x$.<br>
Тогда $\exists K < G$, где $K$ -- **циклическая** и $|K| = d$.

<hr>

**Лемма:** Пусть $G$ -- произвольная конечная группа; $|G| = n$; $H := \{x^m\}_{m \hspace{1} \in \hspace{1} \mathbb{Z}}$. Тогда $G \hspace{3} \vdots \hspace{2} H$.
<br>
...
2. $\sigma \in \text{Hom}(G, G') \Rightarrow \text{Im} \hspace{3} \sigma$ -- циклическая подгруппа $G'$.
